...
const ToastMessage: FC<ToastMessageProps> = ({
  ...
  return (
    <>
      ...
      >
        <div
          className={`inline-flex items-center justify-center shrink-0 w-8 h-8 ${isFailed ? "text-red-500 bg-red-200" : "text-green-500 bg-green-200"} rounded-lg transition-transform duration-300 ${
